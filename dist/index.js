...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simplePubSub = __webpack_require__(9);
	...
	// Input Component
	var Input = _index2.default.createClass({
	    displayName: 'Input',
	    ...
	    render: function render() {
	        return _index2.default.createElement('input', {
	...
	// Button Component
	var Button = _index2.default.createClass({
	    displayName: 'Button',
	    ...
	    render: function render() {
	        return _index2.default.createElement('button', {
	...
	// List Component
	var TodoList = _index2.default.createClass({
	    ...
	    render: function render() {
	        var createItem = function createItem(itemText) {
	            return _index2.default.createElement('li', null, itemText);
	        };
	        ...
	        return _index2.default.createElement('ul', null, lists);
	    },

	    componentDidMount: function componentDidMount() {
	        _simplePubSub2.default.on('add', function (text) {
	            this.add(text);
	        }.bind(this));
	    }
	});
	...
	// Container Component
	var ContainerComponent = _index2.default.createClass({
	    ...
	    // 输入框输入值的事件变化
	    changeHandler: function changeHandler(text) {
	        // 记录下输入框的state
	        this.setState({
	            text: text
	        });
	    ...
	    add: function add() {
	        _simplePubSub2.default.trigger('add', this.state.text);
	    },

	    render: function render() {
	        // 输入框元素
	        var input = _index2.default.createElement(Input, {
	            changeHandler: this.changeHandler.bind(this)
	        });

	        // 添加按钮元素
	        var button = _index2.default.createElement(Button, {
	            add: this.add.bind(this)
	        });

	        // 列表
	        var list = _index2.default.createElement(TodoList);

	        return _index2.default.createElement('div', null, [input, button, list]);
	    }
	});

	_index2.default.render(_index2.default.createElement(ContainerComponent), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.shouldUpdateReactComponent = exports.instantiateReactComponent = undefined;

	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };

	var _textComponent = __webpack_require__(8);

	var _textComponent2 = _interopRequireDefault(_textComponent);

	var _domComponent = __webpack_require__(4);

	var _domComponent2 = _interopRequireDefault(_domComponent);

	var _compositeComponent = __webpack_require__(3);
	...
	var instantiateReactComponent = exports.instantiateReactComponent = function instantiateReactComponent(node) {
	    // 文本节点的情况
	    if (typeof node === 'string' || typeof node === 'number') {
	        return new _textComponent2.default(node);
	    }
	    // 浏览器默认节点的情况
	    if ((typeof node === 'undefined' ? 'undefined' : _typeof(node)) === 'object' && typeof node.type === 'string') {
	        // 注意这里，使用了一种新的component
	        return new _domComponent2.default(node);
	    }
	    // 自定义的元素节点
	    if ((typeof node === 'undefined' ? 'undefined' : _typeof(node)) === 'object' && typeof node.type === 'function') {
	        // 注意这里，使用新的component,专门针对自定义元素
	        return new _compositeComponent2.default(node);
	    }
	};
	...
	var shouldUpdateReactComponent = exports.shouldUpdateReactComponent = function shouldUpdateReactComponent(prevElement, nextElement) {
	...
	var ReactCompositeComponent = function () {
	    ...
	    _createClass(ReactCompositeComponent, [{
	        ...
	        value: function mountComponent(rootID) {
	            ...
	            var renderedComponentInstance = (0, _util.instantiateReactComponent)(renderedElement);
	            ...
	            (0, _jquery2.default)(document).on('mountReady', function () {
	        ...
	        value: function receiveComponent(nextElement, newState) {
	            ...
	            // 合并state
	            var nextState = inst.state = Object.assign(inst.state, newState);
	            ...
	            if ((0, _util.shouldUpdateReactComponent)(prevRenderedElement, nextRenderedElement)) {
	                ...
	                // 替换整个节点
	                (0, _jquery2.default)('[data-reactid="' + this._rootNodeID + '"]').replaceWith(nextMarkup);
	            }
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMComponent = function () {
	    ...
	    _createClass(ReactDOMComponent, [{
	        ...
	        value: function mountComponent(rootID) {
	            ...
	            var elementType = this._currentElement.type;

	            var tagOpen = '<' + elementType;
	            var tagClose = '</' + elementType + '>';
	            ...
	            for (var propKey in props) {
	                ...
	                if (/^on[A-Za-z]/.test(propKey)) {
	                    ...
	                    (0, _jquery2.default)(document).delegate('[data-reactid="' + this._rootNodeID + '"]', eventType + '.' + this._rootNodeID, props[propKey]);
	                }
	            ...
	            children.forEach(function (child, key) {
	                ...
	                var childComponentInstance = (0, _util.instantiateReactComponent)(child);
	                childComponentInstance._mountIndex = key; // 标识该子节点在父节点下的顺序值

	                // 将子节点缓存起来
	                childrenInstances.push(childComponentInstance);
	                // 子节点的rootId是父节点的rootId加上新的key也就是顺序的值拼成的新值
	                var curRootId = me._rootNodeID + '.' + key;
	                // 得到子节点的渲染内容
	        ...
	        value: function receiveComponent(nextElement) {
	            var lastProps = this._currentElement.props; // 记录之前的属性
	            var nextProps = nextElement.props; // 记录此时的属性
	        ...
	        key: '_updateDOMProperties',
	        value: function _updateDOMProperties(lastProps, nextProps) {
	            var propKey = void 0;
	            ...
	            for (propKey in lastProps) {
	                ...
	                if (/^on[A-Za-z]/.test(propKey)) {
	                    var eventType = propKey.replace('on', '');
	                    // 针对当前的节点取消事件代理
	                    (0, _jquery2.default)(document).undelegate('[data-reactid="' + this._rootNodeID + '"]', eventType, lastProps[propKey]);
	                    continue;
	                }

	                // 从dom上删除不需要的属性
	                (0, _jquery2.default)('[data-reactid="' + this._rootNodeID + '"]').removeAttr(propKey);
	            }
	            ...
	            for (propKey in nextProps) {
	                // 对于事件监听的属性我们需要特殊处理
	                if (/^on[A-Za-z]/.test(propKey)) {
	                    var _eventType = propKey.replace('on', '');
	                    // 以前如果已经有，说明有了监听，需要先去掉
	                    lastProps[propKey] && (0, _jquery2.default)(document).undelegate('[data-reactid="' + this._rootNodeID + '"]', _eventType, lastProps[propKey]);
	                    // 针对当前的节点添加事件代理,以_rootNodeID为命名空间
	                    (0, _jquery2.default)(document).delegate('[data-reactid="' + this._rootNodeID + '"]', _eventType + '.' + this._rootNodeID, nextProps[propKey]);
	                    continue;
	                }
	                ...
	                // 添加新的属性，或者是更新老的同名属性
	                (0, _jquery2.default)('[data-reactid="' + this._rootNodeID + '"]').prop(propKey, nextProps[propKey]);
	            }
	        }
	        ...
	        value: function _updateDOMChildren(nextChildrenElements) {
	            updateDepth++;
	        ...
	        key: '_diff',
	        value: function _diff(diffQueue, nextChildrenElements) {
	            var self = this;
	            ...
	            Object.keys(nextChildren).forEach(function (key) {
	                return self._renderedChildren.push(nextChildren[key]);
	            });

	            var lastIndex = 0; // 代表访问老集合最后一次的位置
	            ...
	            for (name in nextChildren) {
	                ...
	                if (prevChild === nextChild) {
	                    ...
	                    prevChild._mountIndex < lastIndex && diffQueue.push({
	                        ...
	                        parentNode: (0, _jquery2.default)('[data-reactid="' + self._rootNodeID + '"]'),
	                    ...
	                    if (prevChild) {
	                        ...
	                        if (prevChild._rootNodeID) {
	                            (0, _jquery2.default)(document).undelegate('.' + prevChild._rootNodeID);
	                        }
	            ...
	            for (name in prevChildren) {
	                if (prevChildren.hasOwnProperty(name) && !(nextChildren && nextChildren.hasOwnProperty(name))) {
	                    ...
	                    if (prevChildren[name]._rootNodeID) {
	                        (0, _jquery2.default)(document).undelegate('.' + prevChildren[name]._rootNodeID);
	                    }
	                }
	            }
	        }
	        ...
	        key: '_patch',
	        value: function _patch(updates) {
	            var update = void 0;
	            var initialChildren = {};
	            var deleteChildren = []; // 存的是jQuery对象
	            ...
	            for (var i = 0; i < updatesLength; i++) {
	                ...
	                if (update.type === UPATE_TYPES.MOVE_EXISTING || update.type === UPATE_TYPES.REMOVE_NODE) {
	                    ...
	                    var updatedChild = (0, _jquery2.default)(update.parentNode.children().get(updatedIndex));
	            ...
	            // 删除所有需要先删除的
	            (0, _jquery2.default)(deleteChildren).remove();
	            ...
	            for (var k = 0; k < updatesLength; k++) {
	                ...
	                switch (update.type) {
	                    case UPATE_TYPES.INSERT_MARKUP:
	                        insertChildAt(update.parentNode, (0, _jquery2.default)(update.markup), update.toIndex);
	                        break;
	...
	function generateComponentChildren(prevChildren, nextChildrenElements) {
	    ...
	    _jquery2.default.each(nextChildrenElements, function (index, element) {
	        var name = element.key ? element.key : index;
	        var prevChild = prevChildren && prevChildren[name];
	        var prevElement = prevChild && prevChild._currentElement; // 对应的前一个组件的元素
	        var nextElement = element;

	        // 调用shouldUpdateReactComponent判断是否是更新
	        if ((0, _util.shouldUpdateReactComponent)(prevElement, nextElement)) {
	            ...
	            var nextChildInstance = (0, _util.instantiateReactComponent)(nextElement, null);
	            // 使用新的component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = {
	    ...
	    createClass: function createClass(spec) {
	        ...
	        // 原型继承，继承超级父类
	        Constructor.prototype = new _reactClass2.default();
	    ...
	    createElement: function createElement(type, config, children) {
	        ...
	        if (childrenLength === 1) {
	            ...
	            props.children = _jquery2.default.isArray(children) ? children : [children];
	    ...
	    render: function render(element, container) {
	        var componentInstance = (0, _util.instantiateReactComponent)(element);

	        var markup = componentInstance.mountComponent(React.nextReactRootIndex++);

	        (0, _jquery2.default)(container).html(markup);

	        // 触发完成mount的事件
	        (0, _jquery2.default)(document).trigger('mountReady');
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMTextComponent = function () {
	    ...
	    _createClass(ReactDOMTextComponent, [{
	        ...
	        key: 'receiveComponent',
	        value: function receiveComponent(nextText) {
	            ...
	            if (nextStringText !== this._currentElement) {
	                ...
	                // 替换整个节点
	                (0, _jquery2.default)('[data-reactid="' + this._rootNodeID + '"]').html(this._currentElement);
	            }
	        }
	    }]);
	...
	exports.default = ReactDOMTextComponent;
